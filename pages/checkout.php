...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>landmark</span>
            <input type="text" placeholder="near" name="landmark" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="puerto princesa" name="city" required>
         </div>
         <div class="inputBox">
            <span>province</span>
            <input type="text" placeholder="palawan" name="state" required>
         </div>
      </div>
